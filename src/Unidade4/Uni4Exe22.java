...
// 2 – Licenciatura da Computação e 3 – Sistemas de Informação) descreva um algoritmo para ler a opção do aluno 
// e escrever uma mensagem informando o título que o aluno vai receber caso opte por aquele curso. 
...
public class Uni4Exe22 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Qual das opções é seu curso:\n"+
